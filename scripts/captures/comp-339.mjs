/**
 * Choreography: comp-339
 * Accordion w/ icon and plus-minus — 4 items with lucide icons, defaultValue="3" open.
...
export default async function capture(page, { W, H, wait }) {
  ...
  // 2. Click first accordion header to expand it (auto-collapses item 3)
  try {
  ...
  // 4. Click second accordion header to expand it (auto-collapses item 1)
  try {
