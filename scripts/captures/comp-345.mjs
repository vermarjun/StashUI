/**
 * Choreography: comp-345
 * Accordion "tabs" w/ plus-minus — card-bordered items with rounded corners, defaultValue="3" open.
...
export default async function capture(page, { W, H, wait }) {
  ...
  // 2. Click first tab-style accordion header (plus-minus icon)
  try {
