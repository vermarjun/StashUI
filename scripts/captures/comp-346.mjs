/**
 * Choreography: comp-346
 * Accordion — Tabs w/ left chevron (space-y-2 cards, single collapsible)
...
export default async function capture(page, { W, H, wait }) {
  ...
  // 2. Click first header (item 1) to expand it
  try {
