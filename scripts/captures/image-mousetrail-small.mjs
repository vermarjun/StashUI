/**
 * Capture choreography for image-mousetrail-small.
 *
 * Shares registry/ui-layouts/mousetrail.tsx + mousetrail.demo.tsx.
 * This variant uses a smaller imgClass so more images are visible in the
 * trail at once.  Same arc pattern — slow wide sweeps to spawn the trail.
 */
