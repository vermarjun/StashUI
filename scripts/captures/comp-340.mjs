/**
 * Choreography: comp-340
 * Accordion w/ sub-header and chevron — 4 taller items with title + subtitle, defaultValue="3" open.
...
export default async function capture(page, { W, H, wait }) {
  ...
  // 2. Click first accordion header (sub-header variant, taller rows)
  try {
