/**
 * Capture choreography for comp-435
 * TYPE: TABS
 * Three horizontal bordered tabs with icons (House, PanelsTopLeft, Box).
 * Underline indicator at bottom; muted background on active. Outlined border style.
