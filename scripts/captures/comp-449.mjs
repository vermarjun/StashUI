/**
 * Capture choreography for comp-449
 * Breadcrumb: HomeIcon (icon-only) → slash → Components → slash → Breadcrumb (current).
 * Sequence: dwell on breadcrumb → hover "Home" icon → hover "Components" link → rest.
 */
