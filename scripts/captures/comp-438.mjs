/**
 * Capture choreography for comp-438
 * TYPE: TABS
 * Three horizontal tabs where each trigger has the icon stacked above the label
 * (flex-col layout). Icons: House, PanelsTopLeft, Box. Underline indicator at bottom.
 * Taller tab triggers due to vertical stacking.
