/**
 * Capture choreography for comp-444
 * Vertical tabs with icons (HouseIcon/PanelsTopLeftIcon/BoxIcon): Overview / Projects / Packages.
...
export default async function capture(page, { W, H, wait }) {
  ...
  // Click "Packages" tab (has BoxIcon)
  try {
