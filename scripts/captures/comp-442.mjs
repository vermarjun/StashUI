/**
 * Capture choreography for comp-442
 * TYPE: TABS (vertical text labels)
 * Three vertical tabs (Overview, Projects, Packages) stacked in a left-side column
 * with full-width triggers. Content panel fills the remaining width to the right.
